...
class WebPage : public QWebPage {
  ...
  public:
    ...
    QVariant invokeWebKitServerFunction(const char *name, const QStringList &arguments);
    QVariant invokeWebKitServerFunction(QString &name, const QStringList &arguments);
